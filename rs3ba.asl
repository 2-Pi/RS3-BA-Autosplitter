state("rs2client")
{
	ushort nmwave : 0x699948, 0x18, 0x38, 0x28, 0x2E80, 0x32;
	byte hmwave : 0x699948, 0x18, 0x38, 0x28, 0xA90, 0x50, 0x30;
	float x : 0x699948, 0x60, 0xBB0, 0x2C;
	float y : 0x699948, 0x60, 0xBB0, 0x34;
	int pocketID : 0x699948, 0x60, 0xCD8, 0x8, 0x70, 0x88;
}
